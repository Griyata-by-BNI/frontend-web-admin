...
const MapWithNearbyPlaces: React.FC<MapWithNearbyPlacesProps> = ({
  center,
  popupText,
  nearbyPlaces,
}) => {
  const availableTypes = nearbyPlaces.filter(
      ...
      <div className="p-2 md:p-6">
        ...
        {availableTypes.length > 0 ? (
          <>
            ...
            <div className="mb-4 -mx-6 md:mx-0">
              <div
                ...
                "
                role="tablist"
                aria-label="Kategori tempat terdekat"
              >
                {availableTypes.map((group) => (
                  <button
                    ...
                    className={`shrink-0 snap-start flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
          ...
          <p className="text-gray-500">
            Tidak ada tempat terdekat yang tersedia.
          </p>
        )}
      </div>
    </div>
...
export { Map, MapWithNearbyPlaces };
