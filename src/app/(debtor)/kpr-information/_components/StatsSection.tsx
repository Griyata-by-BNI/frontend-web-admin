...
export const StatsSection = () => (
  <div className="py-10 bg-white">
    <div className="mx-auto max-w-4xl px-4">
      <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-md p-6 flex flex-col md:flex-row justify-around items-center space-y-6 md:space-y-0 md:space-x-6">
